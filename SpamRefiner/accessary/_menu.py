from SpamRefiner import CMD_LIST, CMD_HELP, tbot
import io
import re
...
about = "**About Me**\n\nI am a SpamRefiner RoBot, A powerful group management bot who can take care of your groups with automated simple regular admin actions!\n\n**My Software Version:** 2.0.1\n**Telethon Version:** 1.21.1\n\n**My Developers:**\n• @Eviral\n• @Denzid\n• @wbavishek\n\nUpdates Channel: [Click Here](t.me/Spam_Refinerswwww3)\nSupport Chat: [Click Here](t.me/SpamRefinerAid)\n\nAnd finally thanks for Supporting me😘"
ad_caption = "Hey! I am Spam Refiner, here to help you manage your groups! I perform most of the admin functions and make your group automated!\n\nJoin @Spam_Refiner for updates.\n@SpamRefinerAid for help and support\n\nYou can checkout more about me via following buttons."
pm_caption = "Hey there! My name is Spam Refiner - I'm a powerful group management bot Made to refine all types of spam, advertisement, Nsfw and many more.!\n\nHit /help to find out more about me and unleash my full potential.\n\n"
pmt = "Hello there! I'm Spam Refiner\nI'm a Telethon Based Spam Refiner bot\n with a Much More features! Have a look\nat the following for an idea of some of \nthe things I can help you with.\n\nMain commands available:\n/start : Starts me, can be used to check i'm alive or not.\n/help : PM's you this message.\nExplore My Commands🙃."
        ...
        await tbot.send_message(
            ...
            buttons=[
                [
                  ...
                  [
                    Button.url(
                        "Add Me To Your Group!", "t.me/Spamrefinerrobot?startgroup=true"
                    ),
                ],
            ],
        )
    else:
        await event.reply("Heya SpamRefiner is here!,\nHow Can I Help Ya.")
...
async def help(event):
    if not event.is_group:
        ...
        await event.reply(
            ...
            buttons=[[Button.url("Click me for help!", "t.me/SpamRefinerrobot?start=help")]],
        )
...
def paginate_help(event, page_number, loaded_plugins, prefix):
    ...
    pairs = pairs[
            ...
            (
                ...
                custom.Button.url(
                    "Source", "https://github.com/CodeTechorg/SpamRefiner"
                ),
